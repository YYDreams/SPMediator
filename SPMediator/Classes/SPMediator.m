...
NSString * const kSPMediatorParamsKeySwiftTargetModuleName = @"kSPMediatorParamsKeySwiftTargetModuleName";

@interface SPMediator ()
...
@implementation SPMediator

#pragma mark - public methods

+ (instancetype)shared
{
    static SPMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[SPMediator alloc] init];
    });
...
{
    NSString *swiftModuleName = params[kSPMediatorParamsKeySwiftTargetModuleName];
...
- (void)NoTargetActionResponseWithTargetString:(NSString *)targetString selectorString:(NSString *)selectorString originParams:(NSDictionary *)originParams
{
    ...
    NSObject *target = [[NSClassFromString(@"SPNoTargetActionProcessor") alloc] init];
